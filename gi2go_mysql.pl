...
##system("wget ftp://ftp.geneontology.org/pub/go/godatabase/archive/latest-lite/go_*-seqdb-tables.tar.gz --directory-prefix=./go_sql/") == 0 or die "\nError: $?\n";
print "done.\n";
